...
for row in csv.reader(f):
    i = i + 1
    filename = "admin.rc%d"%(i) # %d represents a digit which takes the value of i #generating a string and that string will become a filename
...
# %d is a special character it is a blank spot waiting to be filled in
